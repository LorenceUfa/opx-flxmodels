...
type PolicyCondition struct {
	...
	ExtendedCommunity PolicyExtendedCommunity `DESCRIPTION: "BGP Extended Community attribute value to match on when the conditionType is MatchExtendedCommunity - based on RFC 4360."`
}
...
type PolicyAction struct {
	...
	ExtendedCommunity PolicyExtendedCommunity `DESCRIPTION: "BGP Extended Community attribute value when the action attr is ExtendedCommunity."`
